...
<li class="leftnav"><a href="javascript:animatedcollapse.toggle('cont_1')" >Material Handling</a>
	<ul class="secondlevel" id="cont_1" style="display:none">
			<li><a href="http://localhost/www.scomat.com/website/catalogue/product.level3.php?tid=136" >Telehandlers</a></li>
			<li><a href="http://localhost/www.scomat.com/website/catalogue/product.level3.php?tid=155" >Lift Truck - Diesel Range</a></li>
	
			<li><a href="http://localhost/www.scomat.com/website/catalogue/product.level3.php?tid=156" >Lift Truck - Electric</a></li>
			<li><a href="http://localhost/www.scomat.com/website/catalogue/product.level3.php?tid=157" >Lift Truck - Gas</a></li>
	</ul>
	<script type="text/javascript">	animatedcollapse.addDiv('cont_1', 'fade=0,speed=1000,group=pets')</script>
</li>		
...
setCookie:function(name, value, days){
	...
	animatedcollapse.addDiv('backend_create_nav', 'fade=3')
