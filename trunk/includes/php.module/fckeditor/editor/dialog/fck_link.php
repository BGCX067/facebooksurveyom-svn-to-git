<?php
include'../../../../configuration/master.configuration.php';
//include'../../../../function.base/variables.php';

$TheIndex = $absoluteURL."page/index.php";


/*
$mySQL = "SELECT nav_tab_id as id, nav_tab_name as Title FROM navigation_tab WHERE status > '0'";
$recSET = mysql_query($mySQL) or die(mysql_error());
$internal_url = "";
while($recROW = mysql_fetch_assoc($recSET)){
	$title = $recROW['Title'];
	$hlink = "$TheIndex?id=$recROW[id]";
	$internal_url .= "<option value=\"$hlink\"  >$title</option>";
}
...
$internal_url	= CreateParentDropEditor(0,".. ");
	...
	<body scroll="no" style="OVERFLOW: hidden">
		<div id="divInfo" style="DISPLAY: none">
			...
			<select id="cmbLinkType" onchange="SetLinkType(this.value);">
				...
				<option value="internal" fckLang="DlgLnkTypeInternal">Internal URL</option>
			...
			<div id="divLinkTypeInternal" style="DISPLAY: none">
				Internal Links<br />
				<select id="inurl" name="inurl">
					<?php echo $internal_url ?>
				</select>
