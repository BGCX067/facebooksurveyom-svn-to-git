...
FCKConfig.FloatingPanelsZIndex = 99990 ;
...
FCKConfig.ToolbarSets["Webline_basic"] = [
	['Bold','Italic','-','PasteText']
] ;

FCKConfig.ToolbarSets["Webline_full"] = [
	['Source','Templates','Cut','Copy','Paste','PasteText','PasteWord','Image','Flash','Table','Rule','SpecialChar','Undo','Redo','Find','Replace','SelectAll','RemoveFormat','Bold','Italic','Underline','JustifyLeft','JustifyCenter','JustifyRight','JustifyFull','OrderedList','UnorderedList'],
	['Outdent','Indent','Blockquote','CreateDiv','Link','Unlink','Anchor','TextColor','BGColor','FitWindow','ShowBlocks','Style','FontFormat','FontName','FontSize']
] ;
