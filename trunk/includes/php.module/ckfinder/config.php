<?php
//include dirname(dirname(dirname(dirname(dirname(getcwd()))))).'/configuration/master.configuration.php';
...
$baseUrl = $absoluteURL.'multimedia/others/editor/';
...
*/
//$baseDir = resolveUrl($baseUrl);
$baseDir = $docRoot.'multimedia/others/editor/';
