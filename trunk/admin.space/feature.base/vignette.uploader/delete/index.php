...
<div class="delete_picture">
	...
	<form method="post" target="body" action="delete.php?vignette_id=<?php echo $vignette_id?>">
		<h1>Delete this vignette?</h1>
		<span style="color:white">If you wish to delete the vignette click on the <br>button below. Cancel to return to the list</span>
		<p>&nbsp;</p>
		<p>
