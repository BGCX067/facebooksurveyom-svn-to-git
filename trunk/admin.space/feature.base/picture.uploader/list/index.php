...
while ($recROW = mysql_fetch_assoc($recSET)) {
	...
	<div class="picture_uploader_tumb_container">
		<a class="picture" href="<?php echo deSanitizeData($absoluteURL)."admin.space/feature.base/picture.uploader/modify/?multimedia_id=$multimedia_id"?>" rel="lyteframe" rev="width: 430px; height: 130px; scrolling: no;" style="background-image:url('<?php echo deSanitizeData($image_path)?>')"></a>
		<ul>
			...
			<li><a href="<?php echo deSanitizeData($absoluteURL)."admin.space/feature.base/picture.uploader/sort/?nav_tab_id=$nav_tab_id&fid=$feature_id&usort=$usort&dir=up&id=$multimedia_id"?>"><img src="<?php echo deSanitizeData($absoluteURL)?>multimedia/pictures/template/admin.space/icons/arrow-left.gif"></a></li>
			<li><a href="<?php echo deSanitizeData($absoluteURL)."admin.space/feature.base/picture.uploader/sort/?nav_tab_id=$nav_tab_id&fid=$feature_id&usort=$usort&dir=down&id=$multimedia_id"?>"><img src="<?php echo deSanitizeData($absoluteURL)?>multimedia/pictures/template/admin.space/icons/arrow-right.gif"></a></li>
		</ul>
	</div>
<?php }?>
